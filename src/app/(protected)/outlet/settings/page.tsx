...
export default function OutletSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold font-headline">Outlet Settings</h1>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="name">Full Name / Manager Name</Label>
            ...
            <div className="space-y-2">
              ...
              <Input id="role" defaultValue={userData?.role || 'outlet'} disabled className="capitalize" />
            </div>
          </div>
